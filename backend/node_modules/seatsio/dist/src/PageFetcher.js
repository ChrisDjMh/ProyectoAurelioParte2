...
var PageFetcher = /** @class */ (function () {
    ...
    PageFetcher.prototype.fetchAfter = function (afterId, queryParameters, pageSize) {
    ...
    PageFetcher.prototype.fetchBefore = function (beforeId, queryParameters, pageSize) {
        var parameters = queryParameters || {};
        if (beforeId) {
            // @ts-ignore
    ...
    PageFetcher.prototype.fetch = function (queryParameters, pageSize) {
