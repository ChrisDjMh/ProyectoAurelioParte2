...
export type EventManagerMode = 'filterSections' | 'manageCategories' | 'manageChannels' | 'manageForSaleConfig' | 'manageObjectStatuses' | 'manageTableBooking' | 'select' | 'static' | 'createOrder' | 'editOrder';
...
export declare enum OrderChangeType {
...
export interface EventManager extends Pick<SeatingChart, 'clearSelection' | 'deselectCategories' | 'deselectObjects' | 'destroy' | 'findObject' | 'listCategories' | 'listSelectedObjects' | 'selectedObjects' | 'render' | 'rerender' | 'resetView' | 'selectCategories' | 'trySelectObjects' | 'doSelectObjects' | 'setSpotlightObjects' | 'setSpotlightOnSelection' | 'clearSpotlightObjects' | 'zoomToObjects' | 'zoomToSection' | 'zoomToSelectedObjects' | 'pulse' | 'unpulse'> {
